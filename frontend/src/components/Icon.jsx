// Biblioteca de ícones SVG inline (estilo Heroicons/Lucide).
// Uso: <Icon name="cart" size={20} />
// Cor herda de `currentColor` (controla via CSS color).
...
const ICONS = {
  ...
  clothes: (
    <>
      <path d="M16 2l4 2-2 5-3-1v14H9V8L6 9 4 4l4-2c1 0 2 2 4 2s3-2 4-2z" />
    </>
  ),
  book: (
    <>
  ...
  beauty: (
    <>
      <path d="M12 2C8 6 8 10 12 12s4 6 0 10c-4-4-4-8 0-10s4-6 0-10z" />
    </>
  ),
  food: (
    <>
